...
const UserTable: React.FC = () => {
  ...
  return (
    <div className="m rounded-xl bg-[#F8F8F8] p-6 shadow-sm">
        ...
        <table className="mb-32 w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="px-4 py-4 text-left text-[16px] font-medium text-[#616161]">Email</th>
              <th className="px-4 py-4 text-left text-[16px] font-medium text-[#616161]">Phone</th>
              <th className="px-4 py-4 text-left text-[16px] font-medium text-[#616161]">
                Location
              </th>
              <th className="px-4 py-4 text-left text-[16px] font-medium text-[#616161]">Status</th>
              <th className="px-4 py-4 text-left text-[16px] font-medium text-[#616161]">
                Job Posted
              </th>
              <th className="px-4 py-4 text-left text-[16px] font-medium text-[#616161]">
